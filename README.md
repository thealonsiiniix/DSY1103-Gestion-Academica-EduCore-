...
| 3 | ms-academico | 8083 | Carreras + asignaturas + mallas + prerrequisitos |
| 4 | ms-matriculas | 8084 | Matrícula, inscripción a secciones |
| 5 | ms-evaluacion | 8085 | Notas + evaluaciones + reglas de aprobación |
| 6 | ms-asistencia | 8086 | Registro de asistencia y regla del 25%. |
| 7 | ms-finanzas | 8087 | Aranceles + becas + convenios de pago |
